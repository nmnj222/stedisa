        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-4 offset-lg-1 col-md-6 col-sm-6">
                    <div class="footer__widget">
                        ...
                        <ul>
                            ...
                            <li><a href="#">Uputsvo za korišćenje</a></li>
                            <li><a href="#">Aplikacija</a></li>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="footer__widget">
                        <h6>Priključite se našem Newsletter-u</h6>
                        <p>Dobijajte najbolje ponude na e-mail</p>
                        <form action="#">
                ...
                <div class="col-lg-12">
                    <div class="footer__copyright">
                        <div class="footer__copyright__text">
                            <p>
                                Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | <b>stedisa.me</b>
                            </p>
                        </div>
